...
// RemoveUser removes one or more Users from store
func RemoveUser(ctx context.Context, s Users, rr ...*types.User) error {
	return s.RemoveUser(ctx, rr...)
}

// RemoveUserByID removes User from store
func RemoveUserByID(ctx context.Context, s Users, ID uint64) error {
	return s.RemoveUserByID(ctx, ID)
}

// TruncateUsers removes all Users from store
func TruncateUsers(ctx context.Context, s Users) error {
	return s.TruncateUsers(ctx)
}

func CountUsers(ctx context.Context, s Users, f types.UserFilter) (uint, error) {
	return s.CountUsers(ctx, f)
}
